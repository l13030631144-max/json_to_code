...
void TestDialog::initialize_cb()
{
    try
    {
        ...
        blockInteger_main = dynamic_cast<PWOpen::BlockStyler::IntegerBlock*>(theDialog->TopBlock()->FindBlock("blockInteger_main"));
        blockDouble_main = dynamic_cast<PWOpen::BlockStyler::DoubleBlock*>(theDialog->TopBlock()->FindBlock("blockDouble_main"));
        blockExpression_main = dynamic_cast<PWOpen::BlockStyler::ExpressionBlock*>(theDialog->TopBlock()->FindBlock("blockExpression_main"));
...
int TestDialog::update_cb(PWOpen::BlockStyler::UIBlock* block)
{
    try
    {
        ...
        else if (block == blockInteger_main)
        {
        }
        else if (block == blockDouble_main)
        {
        }
        else if (block == blockExpression_main)
        {
        }
