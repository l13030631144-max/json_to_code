...
private:
    ...
    PWOpen::BlockStyler::IntegerBlock* blockInteger_main;
    PWOpen::BlockStyler::DoubleBlock* blockDouble_main;
    PWOpen::BlockStyler::ExpressionBlock* blockExpression_main;
    PWOpen::BlockStyler::LinearDimension* blockLinear_main;
};
