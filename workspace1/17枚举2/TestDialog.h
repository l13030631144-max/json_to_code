...
private:
    ...
    PWOpen::BlockStyler::Enumeration* enum_main;
    PWOpen::BlockStyler::Toggle* blockToggle_main;
    PWOpen::BlockStyler::Label* blockLabel_main;
    PWOpen::BlockStyler::Button* blockButton_main;
};
