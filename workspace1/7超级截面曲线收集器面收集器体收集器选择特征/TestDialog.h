...
private:
    ...
    PWOpen::BlockStyler::CurveCollector* curveCollector_main;
    PWOpen::BlockStyler::FaceCollector* faceCollector_main;
    PWOpen::BlockStyler::BodyCollector* bodyCollector_main;
    PWOpen::BlockStyler::UIBlock* selectFeature_main;
};
