...
private:
    ...
    PWOpen::BlockStyler::RGBColorPicker* rgbColorPicker_color;
    PWOpen::BlockStyler::DrawingArea* drawingArea_preview;
    PWOpen::BlockStyler::LayerBlock* blockLayer_layer;
};
