...
void TestDialog::initialize_cb()
{
    try
    {
        ...
        sectionBuilder_section = dynamic_cast<PWOpen::BlockStyler::SectionBuilder*>(theDialog->TopBlock()->FindBlock("section0"));
        ...
        selectFeature_feature = dynamic_cast<PWOpen::BlockStyler::SelectFeature*>(theDialog->TopBlock()->FindBlock("select_feature0"));
        facetSelect_facet = dynamic_cast<PWOpen::BlockStyler::SelectFacetRegion*>(theDialog->TopBlock()->FindBlock("facetSelect0"));
...
int TestDialog::update_cb(PWOpen::BlockStyler::UIBlock* block)
{
    try
    {
        ...
        else if (block == sectionBuilder_section)
        {
        }
        ...
        else if (block == selectFeature_feature)
        {
        }
        else if (block == facetSelect_facet)
        {
        }
